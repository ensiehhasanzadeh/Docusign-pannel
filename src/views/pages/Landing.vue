...
const { state: token, isLoading } = useAsyncState(async () => {
...
<template>
    <div v-if="!isLoading" class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div
                ...
                <a class="flex align-items-center" href="#"> <img src="@/assets/images/ds.png" alt="Sakai Logo" height="50"
                        class="mr-0 lg:mr-2" /><span
                        class="text-900 font-medium text-2xl line-height-3 mr-8">DocuSign</span> </a>
                ...
                <div class="align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2"
                    ...
                    <ul
                        ...
                        <li>
                            <a href="#" @click="smoothScroll('#hero')"
                                class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" v-ripple>
            ...
            <div id="hero" class="flex flex-column pt-4 px-4 lg:px-8 overflow-hidden"
                ...
                <div class="mx-4 md:mx-8 mt-0 md:mt-4">
                    ...
                    <p class="font-normal text-2xl line-height-3 mt-3 md:mt-5 text-gray-700">{{ t('docusignDescription') }}
                    </p>
                </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        <div
                            ...
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <span class="text-600">در صورت تغییر دوطرف از آن آگاه و در صورت تایید تغییر پیدا
                                    می‌کند</span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="highlights" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                ...
                <div class="grid mt-8 pb-2 md:pb-8">
                    ...
                    <div class="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
                        ...
                        <h2 class="line-height-1 text-900 text-4xl font-normal">{{ t('howDSWork') }}</h2>
            ...
            <div class="py-4 px-4 mx-0 mt-8 lg:mx-8">
                ...
                <div class="grid justify-content-between">
                    <div class="col-12 md:col-2" style="margin-top: -1.5rem">
                        ...
                        <LanguageButton class="flex justify-content-center mt-3 md:mt-5" />
                    </div>

                    <div class="col-12 md:col-10 lg:col-7">
                        <div class="grid text-center md:text-left">
                            <div class="col-12 md:col-3">
                                <h4 class="font-medium text-2xl line-height-3 mb-3 text-900">{{ t('home') }}</h4>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">{{ t('test') }}</a>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">{{ t('test') }}</a>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">{{ t('test') }}</a>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">{{ t('test') }}</a>
                            </div>
                            ...
                            <div class="col-12 md:col-3 mt-4 md:mt-0">
                                <h4 class="font-medium text-2xl line-height-3 mb-3 text-900">{{ t('home') }}</h4>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">{{ t('test') }}</a>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">{{ t('test') }}<img
