      ...
      <div
        ...
        <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px; max-width: 560px;">
          ...
          <div>
            ...
            <Password id="password" v-model="password" :placeholder="t('password')" :toggleMask="true" class="w-full mb-3"
              inputClass="w-full" :inputStyle="{ padding: '1rem' }" />
            <BaseButton :action="signUp" :label="t('signUp')" class="w-full p-3 text-xl mt-5" />
          </div>
        </div>
      </div>
    </div>
